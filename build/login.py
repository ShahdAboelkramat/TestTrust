...
def relative_to_assets(path: str) -> Path:
    ...
    button_image_2 = PhotoImage(file=relative_to_assets("button_create.png"))
    button_image_3 = PhotoImage(file=relative_to_assets("button_back.png"))
    button_image_4 = PhotoImage(file=relative_to_assets("button_login.png"))
